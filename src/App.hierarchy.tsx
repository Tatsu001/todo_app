...
function App() {
  console.log('App with hierarchy rendering...');
        ...
        >
          ...
          <div className="ml-6 space-y-2">
            ...
            <button
              ...
              className="w-full py-2 px-3 border-2 border-dashed border-blue-300 rounded-lg text-blue-600 hover:border-blue-400 hover:bg-blue-50 transition-colors text-sm"
            >
      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-white shadow-sm border-b border-gray-200">
          <div className="max-w-4xl mx-auto px-4 py-6">
            <h1 className="text-2xl font-bold text-gray-900">Todo App (Hierarchy Version)</h1>
            <p className="text-gray-600 mt-1">
              Tasks: {filteredTasks.length}, Folders: {state.folders.length}
            </p>
          </div>
        </header>
